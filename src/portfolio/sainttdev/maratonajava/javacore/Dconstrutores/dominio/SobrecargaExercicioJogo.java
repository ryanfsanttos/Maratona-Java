package portfolio.sainttdev.maratonajava.javacore.Dconstrutores.dominio;
...
public class SobrecargaExercicioJogo {
    ...
    public SobrecargaExercicioJogo(String nome, String genero, int idadeClassificacao, int ano){
        this.nome = nome;
        this.genero = genero;
    ...
    public SobrecargaExercicioJogo(String nome, String genero, int idadeClassificacao, int ano, String empresa){
        this(nome, genero, idadeClassificacao, ano);
